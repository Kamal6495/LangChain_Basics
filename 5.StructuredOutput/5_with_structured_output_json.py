...
json_schema={
  ...
  "properties": {
    "key_themes": {
      "type": "array",
      "items": { "type": "string" },
      "description": "Write down all the key themes as discussed in review in a list"
    },
    "summary": {
      "type": "string",
      "description": "Write Summary of the review concisely"
    },
    "sentiment": {
      "type": "string",
      "enum": ["Pos", "Neg"],
      "description": "Return sentiment of review either Positive or Negetive"
    },
    "pros": {
      "type": ["array", "null"],
      "items": { "type": "string" },
      "description": "write all the advantages of product in review"
    },
    "cons": {
      "type": ["array", "null"],
      "items": { "type": "string" },
      "description": "write all the disadvantages of product in review"
    },
    "name": {
      "type": ["array", "null"],
      "items": { "type": "string" },
      "description": "write all the name of reviewer"
    }
...
# print(result.name) #Because result is a Python dict (not an object with attributes).
...
print("Reviewer:", result.get("reviewer"))
