...
# Map chain (works same as RunnableParallel)
map_chain = RunnableMap({
    "Video Game Characters": prompt1 | llm | parser,
    "Best Thoughts": prompt2 | llm | parser
})

# Run
result = map_chain.invoke({"topic": "Crysis 2"})
print(result)
